/* Emma Basic — product data (CMS-managed). The payload below is strict JSON. */
window.EB_PRODUCTS = [
  {
    "id": "curry-cubes",
  ...
  },
  {
    ...
    "ingredients": [
      "Tencha (green tea). Shade-grown for 25 days prior to harvest."
    ],
    "notTested": [
      "Additives",
      "Fillers",
  ...
  },
  {
    ...
    "ingredients": [
      "Sesame oil (100%). Physically pressed, unrefined."
    ],
    "notTested": [
      "Hexane residue",
      "Bleaching agents",
  ...
  },
  {
    ...
    "usps": [
      ...
      "UDON SOUP: Mix 50ml of Dashi Soy Sauce into 200ml boiling water, serve with cooked udon noodles.",
      "VERSATILE: This item can be used as a dipping sauce, as a soup base, and for stir fries."
    ],
    "ingredients": [
      "Soy sauce",
      "Dashi (kombu, bonito)",
