...
window.EB_HOME = {
  ...
  "banner": {
    "text": "The only mainstream brand in UK retail committed to additive-free across the entire range.",
    "tag": "Never Any Additives."
  },
  "founder": {
    "image": "assets/homepage/office-photo.webp",
